...
--[[
It seems that's only way to show my underline cursor line, don't know why yet:)
--]]

-- Transparent but with underline and bold test
-- vim.cmd 'hi CursorLine guifg=NONE ctermfg=NONE guibg=NONE ctermbg=NONE gui=bold,underline cterm=bold,underline'
