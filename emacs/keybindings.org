...
#+BEGIN_SRC emacs-lisp
  ...
  (defun my-bind-q-kill-current-window-local()
    ;;
    ;; Disable the 'SPC' binding first before binding local, otherwise,
    ;; '<leader>' won't work correctly!!!
    ;;
    ;; (define-key dired-mode-map (kbd "SPC") nil)
    ;; (define-key xref--xref-buffer-mode-map (kbd "SPC") nil)
...
#+BEGIN_SRC emacs-lisp
  (defun my-dired-o-to-open-file-local()
    (evil-local-set-key 'normal (kbd "o") 'dired-find-file-other-window)
  )
#+END_SRC
