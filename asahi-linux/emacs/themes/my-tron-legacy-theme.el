;;; my-tron-legacy-theme.el --- An original retro-futuristic theme inspired by Tron: Legacy -*- lexical-binding: t; -*-

;; Copyright (C) 2018-2020 Ian Y.E. Pan

;; Author: Ian Y.E. Pan
;; URL: https://github.com/ianpan870102/my-tron-legacy-emacs-theme
;; Version: 2.0.0
...
(defgroup my-tron-legacy-theme nil
  "Options for my-tron-legacy theme."
  :group 'faces)

(defcustom my-tron-legacy-theme-dark-fg-bright-comments nil
  "If non-nil, default foreground will be dimmed and comments will be boosted to be brighter than the normal foreground."
  :group 'my-tron-legacy-theme
  :type 'boolean)

(defcustom my-tron-legacy-theme-vivid-cursor nil
  "If non-nil, the cursor will be bright golden, making it easier to spot."
  :group 'my-tron-legacy-theme
  :type 'boolean)

(defcustom my-tron-legacy-theme-softer-bg nil
  "If non-nil, the contrast of the background will be slightly lower, instead of being pure black."
  :group 'my-tron-legacy-theme
  :type 'boolean)

(deftheme my-tron-legacy)
(let ((class '((class color) (min-colors 89)))

      ;; standardized palette
      (tron-yellow         "#DEB45B")
      (tron-yellow-2       "#FFE64D")
      (tron-bluegreen      "#4BB5BE")
      (tron-magenta        "#B62D66")
      (tron-orange         "#DEB45B")
      (tron-orange-2       "#FF9F1C")
      (tron-red            "#B62D66")
      (tron-blue           "#8Fd4FF")
      (tron-green          "#4BB5BE")
      (tron-lightred       "#f44747")
      (tron-lightblue      "#A0DCFF")
      (tron-lightblue-2    "#ACE6FE")
      ...
      (tron-darkgrey       "#2E2E2E")

      (fg0               "#90ACBC")
      (fg1               (if my-tron-legacy-theme-dark-fg-bright-comments "#5A7387" "#B0CCDC")) ; default fg
      (fg2               "#BBCCDD")
      (fg3               "#BBF0EF")
      (fg4               "#CBECFF")
      (bg0               "#000000")
      (bg1               (if my-tron-legacy-theme-softer-bg "#17181b" "#000000")) ; default bg
      (bg2               (if my-tron-legacy-theme-softer-bg "#192533" "#0E1926"))
      (bg3               "#1B324B")
      (bg4               "#2B4255")
      ...
      (line-num          "#5A7387")
      (cursor            (if my-tron-legacy-theme-vivid-cursor "#DEB45B" "#B0CCDC"))
      (builtin           "#8Fd4FF")
      (keyword           "#8Fd4FF")
      (const             "#BBF0EF")
      (comment           (if my-tron-legacy-theme-dark-fg-bright-comments "#B0CCDC" "#5A7387"))
      (doc               "#6A8397")
      (type              "#4BB5BE")
      (type2             "#FFE64D") ; tron-yellow-2
      (str               "#387AAA")
      (str2              "#FFE64D") ; tron-yellow-2
      (str3              "#FF9F1C") ; tron-orange-2
      (func              "#DEB45B")
      (var               (if my-tron-legacy-theme-dark-fg-bright-comments "#5A7387" "#B0CCDC")) ; var = fg
      (warning           "#FF7DBB")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-string-face                    ((,class (:foreground ,str3))))
   `(font-lock-type-face                      ((,class (:foreground ,type2 ))))
   ...
   `(hl-line                                  ((,class (:background ,tron-darkgrey))))
   ...
   ;;;;; Org mode
   `(org-document-title                       ((,class (:foreground ,type2 :height 1.2 :bold t))))
   `(org-level-1                              ((,class (:bold nil :foreground ,tron-bluegreen :height 1.1))))
   `(org-level-2                              ((,class (:bold nil :foreground ,tron-bluegreen))))
   `(org-level-3                              ((,class (:bold nil :foreground ,tron-bluegreen))))
   `(org-level-4                              ((,class (:bold nil :foreground ,tron-bluegreen))))
   `(org-code                                 ((,class (:foreground ,tron-orange-2))))
   `(org-hide                                 ((,class (:foreground ,fg4))))
   `(org-date                                 ((,class (:underline t :foreground ,var) )))
   `(org-footnote                             ((,class (:underline t :foreground ,fg4))))
   `(org-link                                 ((,class (:underline t :foreground ,type2 ))))
   ...
   `(org-scheduled                            ((,class (:foreground ,type2))))
   `(org-scheduled-today                      ((,class (:foreground ,func :weight normal :height 1.2))))
   `(org-ellipsis                             ((,class (:foreground ,builtin))))
   `(org-verbatim                             ((,class (:foreground ,tron-yellow))))
   `(org-document-info-keyword                ((,class (:foreground ,tron-green))))
   `(org-sexp-date                            ((,class (:foreground ,fg4))))

   ;;;;; LaTeX
   `(font-latex-bold-face                     ((,class (:foreground ,type2))))
   `(font-latex-italic-face                   ((,class (:foreground ,key3 :italic t))))
   `(font-latex-string-face                   ((,class (:foreground ,str3))))
   ...
   `(gnus-header-name                         ((,class (:foreground ,type2))))
   `(gnus-header-subject                      ((,class (:foreground ,func :bold nil))))

   ;;;;; Mu4e
   `(mu4e-view-url-number-face                ((,class (:foreground ,type2))))
   `(mu4e-cited-1-face                        ((,class (:foreground ,fg2))))
   `(mu4e-cited-7-face                        ((,class (:foreground ,fg3))))
   `(mu4e-header-marks-face                   ((,class (:foreground ,type2))))
   ...
   `(js2-jsdoc-html-tag-delimiter             ((,class (:foreground ,str3))))
   `(js2-jsdoc-html-tag-name                  ((,class (:foreground ,key2))))
   `(js2-external-variable                    ((,class (:foreground ,type2  ))))
   `(js2-function-param                       ((,class (:foreground ,const))))
   `(js2-jsdoc-value                          ((,class (:foreground ,str3))))
   ...
   `(info-string                              ((,class (:foreground ,str3))))
   `(icompletep-determined                    ((,class :foreground ,builtin)))

   ;;;;; Slime
   `(slime-repl-inputed-output-face           ((,class (:foreground ,type2))))

   ;;;;; Undo tree
   `(undo-tree-visualizer-current-face        ((,class :foreground ,builtin)))
   `(undo-tree-visualizer-default-face        ((,class :foreground ,fg2)))
   `(undo-tree-visualizer-unmodified-face     ((,class :foreground ,var)))
   `(undo-tree-visualizer-register-face       ((,class :foreground ,type2)))
   ...
   `(helm-separator                           ((,class (:foreground ,type2 :background ,bg1))))
   `(helm-time-zone-current                   ((,class (:foreground ,builtin :background ,bg1))))
   `(helm-time-zone-home                      ((,class (:foreground ,type2 :background ,bg1))))
   `(helm-buffer-not-saved                    ((,class (:foreground ,type2 :background ,bg1))))
   ...
   `(helm-source-go-package-godoc-description ((,class (:foreground ,str3))))
   `(helm-bookmark-w3m                        ((,class (:foreground ,type2))))

   ;;;;; web-mode
   `(web-mode-html-tag-bracket-face           ((,class (:foreground ,doc))))
   `(web-mode-html-tag-face                   ((,class (:foreground ,type2))))
   `(web-mode-html-attr-name-face             ((,class (:foreground ,var))))
   `(web-mode-html-attr-value-face            ((,class (:foreground ,str3))))
   ...
   `(web-mode-string-face                     ((,class (:foreground ,str3))))
...
(provide-theme 'my-tron-legacy)
(provide 'my-tron-legacy-theme)

;;; my-tron-legacy-theme.el ends here
