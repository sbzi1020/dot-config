...
let g:colors_name='tron-white'
set t_ZH=^[[3m
set t_ZR=^[[23m

" ----------------------------------------------------------------------------
"
" `Neovim` uses the `highlight group` to render text in different background
" color and foreground color. Here is the `hi` command syntax:
"
" `hi {group_name} guifg={foreground_color} guibg={background_color} gui={font_style_separated_with_comma}`
"
...
" Tips:
"
"   1. How could I know which highlight-group on the parituclar text category?
"
"      Put your cursor on the any text you want to know, then run the the
"      following:
"
"      `:TSHighlightCapturesUnderCursor`
"
"      In the floating window shows like below:
"
"       # Treesitter
"       * @comment
"       * @spell
"
"      That means the highlight group name is either one the following:
"      - TSComment
"      - TSSpell
"
"
...
"       * @function.call
"
"      That means the highlight group name is:
"      - TSFunctionCall
"
"      `TS` means `TreeSitter`, so you can add your custom highlight group
"      settings:
"
"      `hi TSFunctionCall guifg=#00FF00 guibg=NONE gui=NONE`
"
"
"   2. How could I print or search all available highlight groups and
"      its settings?
"
"      A: Run `:Telescope highlights` to show the prompt, search, enter to
"         print the selected highlight group settings
"
"      B: If you know the highlight group name, then run `:hl {group_Name_here}`
"
"      C: You can run `:highlight` to print all supported groups (included
"         all installed plugin groups).
"
" ----------------------------------------------------------------------------
...
hi Cursor1 guifg=#23211b ctermfg=235 guibg=#FFFFFF ctermbg=80 gui=NONE cterm=NONE
hi Cursor2 guifg=#23211b ctermfg=235 guibg=#FFFFFF ctermbg=80 gui=NONE cterm=NONE
...
hi healthSuccess guifg=#23211b ctermfg=80 guibg=#FFFFFF ctermbg=60 gui=NONE cterm=NONE
...
" --------------------------------------------------------
" Floating window
hi NormalFloat guifg=#FFFFFF ctermfg=60 guibg=#23211b ctermbg=235 gui=NONE cterm=NONE
hi FloatBorder guifg=#FFFFFF ctermfg=60 guibg=#23211b ctermbg=235 gui=NONE cterm=NONE


" --------------------------------------------------------
" Popup menu (code complection, hover floating window, error window)
hi Pmenu guifg=#FFFFFF ctermfg=80 guibg=#011627 ctermbg=233 gui=NONE cterm=NONE
hi PmenuSbar guifg=#FFFFFF ctermfg=80 guibg=#011627 ctermbg=60 gui=NONE cterm=NONE
hi PmenuSel guifg=#23211b ctermfg=195 guibg=#FF9F1C ctermbg=235 gui=NONE cterm=NONE
hi PmenuThumb guifg=#FFFFFF ctermfg=195 guibg=#9DB4C0 ctermbg=60 gui=NONE cterm=NONE


" --------------------------------------------------------
" `nvim-cmp` complection menu
hi CmpItemAbbrDeprecated guifg=#FFFFFF ctermfg=80 guibg=#011627 ctermbg=233 gui=NONE cterm=NONE
hi CmpItemAbbrMatch guifg=#FFFFFF ctermfg=195 guibg=#011627 ctermbg=60 gui=NONE cterm=NONE
hi CmpItemAbbrMatchFuzzy guifg=#FFFFFF ctermfg=195 guibg=#011627 ctermbg=60 gui=NONE cterm=NONE
...
hi TSStringEscape guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE


" --------------------------------------------------------
" Normal text (all code non-keyword/function, popup window non-selected, etgc)
hi Normal guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=235 gui=NONE cterm=NONE
...
hi SpellLocal guifg=#FFFFFF ctermfg=80 guibg=#23211b ctermbg=235 gui=underline cterm=underline
hi SpellRare guifg=#FFFFFF ctermfg=80 guibg=#23211b ctermbg=235 gui=underline cterm=underline


" --------------------------------------------------------
" Status line
" hi StatusLine guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi StatusLine guibg=#00000000 gui=NONE cterm=NONE
hi StatusLineNC guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi StatusLineTerm guifg=#FFFFFF ctermfg=195 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi StatusLineTermNC guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE


" --------------------------------------------------------
" Message
hi ModeMsg guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi MoreMsg guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi WarningMsg guifg=#23211b ctermfg=235 guibg=#FF9F1C ctermbg=172 gui=NONE cterm=NONE


" --------------------------------------------------------
" Tab
hi TabLine guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi TabLineFill guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi TabLineSel guifg=#FFFFFF ctermfg=195 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
...
" --------------------------------------------------------
" Uncategory yet
hi MatchParen guifg=#FFFFFF ctermfg=195 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
...
hi Terminal guifg=#FFFFFF ctermfg=80 guibg=#23211b ctermbg=235 gui=NONE cterm=NONE
...
hi Directory guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi EndOfBuffer guifg=#616e88 ctermfg=60 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Question guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE

hi WildMenu guifg=#FFFFFF ctermfg=195 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
hi Title guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Boolean guifg=#ffe64d ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Character guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Constant guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Define guifg=#ffe64d ctermfg=221 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi Delimeter guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi Function guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi Identifier guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi SpecialComment guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=italic cterm=italic
...
hi Tag guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi DiffAdd guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
...
hi diffAdded guifg=#FFFFFF ctermfg=80 guibg=#616e88 ctermbg=60 gui=NONE cterm=NONE
...
hi diffNewFile guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi diffOldFile guifg=#f44747 ctermfg=203 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi gitconfigVariable guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi debugPc guifg=NONE ctermfg=NONE guibg=#FFFFFF ctermbg=80 gui=NONE cterm=NONE
...
hi TSPunctBracket guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSPunctSpecial guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSConstant guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSConstBuiltin guifg=#ffe64d ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSConstMacro guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSCharacter guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSAttribute guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSNamespace guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFuncBuiltin guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSFunction guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSFuncMacro guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi TSParameter guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSParameterReference guifg=#ffe64d ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSMethod guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSField guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSProperty guifg=#FFFFFF ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSConstructor guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSLabel guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSType guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSVariable guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSVariableBuiltin guifg=#ffe64d ctermfg=221 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSText guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSStrong guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSEmphasis guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi TSUnderline guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi TSURI guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
" --------------------------------------------------------
" Html
hi htmlArg guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlBold guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi htmlEndTag guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi htmlLink guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=underline cterm=underline
hi htmlSpecialChar guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlSpecialTagName guifg=#FF9F1C ctermfg=172 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlTag guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi htmlTitle guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE

" --------------------------------------------------------
" Markdown
hi markdownBlockquote guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi markdownBold guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=bold cterm=bold
hi markdownCode guifg=#BBBBBB ctermfg=80 guibg=NONE ctermbg=NONE gui=bold,italic cterm=bold,italic
hi markdownCodeBlock guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi markdownUrl guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=underline cterm=underline

" --------------------------------------------------------
" Coc plugin
hi CocExplorerIndentLine guifg=#5c6370 ctermfg=241 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerBufferRoot guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi CocExplorerFileRoot guifg=#FFFFFF ctermfg=80 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi CocInfoSign guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
" hi LspDiagnosticsInformation guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
" hi LspDiagnosticsUnderlineInformation guifg=#FFFFFF ctermfg=195 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
...
hi GalaxyShowGitBranch guifg=#FFFFFF guibg=NONE gui=bold
...
hi GalaxyLinePercent guifg=#FFFFFF guibg=NONE gui=bold
...
hi GalaxyLineColumn guifg=#FFFFFF guibg=NONE
hi GalazyLineColumnSeparator guibg=NONE

" --------------------------------------------------------
" Rust
"hi rustTSInclude guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
"hi rustTSNamespace guifg=#ACE6FF ctermfg=176 guibg=NONE ctermbg=NONE gui=italic cterm=italic
"hi rustModPath guifg=#ACE6FF ctermfg=176 guibg=NONE ctermbg=NONE gui=italic cterm=italic
"hi rustModPathSep guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=italic cterm=italic
"
"hi rustTSPunctDelimiter guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
"hi rustTSOperator guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
"
""hi rustFoldBraces guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
"
hi rustCommentLineDoc guifg=#616e88 ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
hi rustTSLabel guifg=#FFE64D ctermfg=176 guibg=NONE ctermbg=NONE gui=bold cterm=NONE

hi typescriptImport guifg= ctermfg=221 guibg=NONE ctermbg=NONE gui=bold cterm=NONE
