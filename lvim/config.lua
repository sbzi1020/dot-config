...
-----------------------------------------------------------------------
-- ctrl+s: replace all works under cursor. Do a `/pattern` which the `pattern` is the word under cursor.
...
-- terminal
lvim.builtin.which_key.mappings["t"] = { ":ToggleTermToggleAll<CR>", "terminal" }
